...
describe FindNumber do
  ...
  describe '#make_guess' do
    ...
    context 'when min is 5 and max is 9' do
      it 'returns 7' do
        expect(game_five_nine.make_guess).to eq(7)
      end
    end
    ...
    context 'when min is 8 and max is 9' do
      it 'returns 8' do
        expect(game_eight_nine.make_guess).to eq(8)
      end
    end
    ...
    context 'when min is 0 and max is 3' do
      it 'returns 1' do
        expect(game_zero_three.make_guess).to eq(1)
      end
    end
    ...
    context 'when min and max both equal 3' do
      it 'returns 3' do
        expect(game_three_three.make_guess).to eq(3)
      end
    end
  end
  ...
  describe '#game_over?' do
    context 'when guess and random_number are equal' do
      ...
      subject(:game_is_over) { described_class.new(0, 9, random_number, 4) }
      it 'is game over' do
        expect(game_is_over.game_over?).to be true
      end
    end
    ...
    context 'when guess and random_number are not equal' do
      let(:random_number) { double('random_number', value: 4) }
      subject(:game_is_not_over) { described_class.new(0, 9, random_number, 7) }

      it 'is not game over' do
        expect(game_is_not_over.game_over?).to be false
      end
    end
  end
  ...
  describe '#update_range' do
    ...
    context 'when the guess is 7, min=5, and max=8' do
      subject(:weird_guess_game) { described_class.new(5, 8, number_range, 7) }

      before do
        weird_guess_game.update_range
      end

      it 'updates min to the same value as max' do
        min = weird_guess_game.min
        max = weird_guess_game.max
